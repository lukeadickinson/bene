...
class Main(object):
    ...
    def run(self):
        ...
        # setup connection
        c1 = TCP(t1, n1.get_address('n2'), 1, n2.get_address('n1'), 1, self.retransmit, a, window=2000)
        c2 = TCP(t2, n2.get_address('n1'), 1, n1.get_address('n2'), 1, self.retransmit, a, window=2000)
